...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/josep/Desktop/qbio_490_joseph_kim/week3_R")) 
```
...
string_var <- "This is QBIO490's Spring 2023 Class"
char_var <- 'a'
...
```{r Exercise 5.5}
# I predict that the code segment will run the 3rd if-else condition ('starbucks' is in the list) and print "D" and "E"
